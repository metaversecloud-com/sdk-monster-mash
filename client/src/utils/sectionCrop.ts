...
export const SECTION_CROP: Record<Section, SectionCrop> = {
  head: {
    ...
    parts: {
      headShape: { marginTop: "-25px", height: "50px" },
      nose: { marginTop: "-35px", height: "50px" },
      eyes: { marginTop: "-30px", height: "50px" },
      mouth: { marginTop: "-35px", height: "50px" },
      hair: { marginTop: "0px", height: "70px" },
    },
  },
  torso: {
    marginTop: "-65px",
    ...
    parts: {
      arms: { marginTop: "-50px", height: "80px" },
      collar: { marginTop: "-45px", height: "80px" },
      shirt: { marginTop: "-45px", height: "80px" },
      torsoBack: { marginTop: "-35px", height: "80px" },
    },
  },
  legs: {
    marginTop: "-80px",
    ...
    parts: {
      ...
      legs: { marginTop: "-55px", height: "70px" },
